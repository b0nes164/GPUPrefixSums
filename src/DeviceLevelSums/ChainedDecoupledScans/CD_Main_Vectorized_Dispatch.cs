...
public class CD_Main_Vectorized_Dispatch : DeviceBase
{
    CD_Main_Vectorized_Dispatch()
    {
        partitionSize = 8192;
        threadBlocks = 256;
        mainKernelString = "CD_Main_Vectorized";
        testKernelString = "CD_Main_Vectorized_Timing";
        computeShaderString = "CD_Main_Vectorized";
    }
